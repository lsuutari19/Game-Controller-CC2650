...
Void musicTask() {
    buzzerOpen(hBuzzer);
	buzzerSetFrequency(659.25);  //E5
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(293.66);  //D4
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(130.81);  //C3
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(130.81); //C3
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(293.66); //D4
	...
	buzzerSetFrequency(659.25);  //E5
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(1396.91);	//F6
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(3135.96);	//G7
	Task_sleep(5000 / Clock_tickPeriod);
	buzzerSetFrequency(659.25);	//G7
